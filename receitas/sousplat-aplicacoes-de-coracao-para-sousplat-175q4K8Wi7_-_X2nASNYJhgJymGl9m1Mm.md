# Aplicações de Coração para Sousplat
...
Esta apostila acompanha a videoaula **Aplicações de Coração para Sousplat** e foi ampliada para oferecer mais clareza tecnica no processo.