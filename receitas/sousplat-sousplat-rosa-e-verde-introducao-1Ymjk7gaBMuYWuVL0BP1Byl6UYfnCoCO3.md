...
Este PDF foi estruturado para acompanhamento direto da videoaula **Sousplat Rosa e Verde - Introdução**, facilitando a execução passo a passo durante o aprendizado.